    ...
    return (
        <div className="w-full max-w-[400px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <div className="relative group">
                                        <User className="absolute left-3 top-3 h-4 w-4 text-slate-400 group-focus-within:text-sky-500 transition-colors" />
                                        <Input
                                            placeholder="Juan Dela Cruz"
                                            {...field}
                                            className="pl-9 h-11 bg-white dark:bg-slate-950/50 border-slate-200 dark:border-white/10 focus:ring-2 focus:ring-sky-500/20 transition-all"
                                        />
                                    </div>
                                </FormControl>
                                <FormMessage />
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <div className="relative group">
                                        <Mail className="absolute left-3 top-3 h-4 w-4 text-slate-400 group-focus-within:text-sky-500 transition-colors" />
                                        <Input
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="relative group">
                                            <Lock className="absolute left-3 top-3 h-4 w-4 text-slate-400 group-focus-within:text-sky-500 transition-colors" />
                                            <Input
                                                type="password"
                                                placeholder="••••••"
                                                {...field}
                    ...
                    <Button
                        type="submit"
                        disabled={isLoading}
                        className="w-full h-11 text-base font-semibold bg-sky-600 hover:bg-sky-700 text-white shadow-lg shadow-sky-500/20 hover:shadow-sky-500/30 transition-all mt-2 cursor-pointer"
                    >
                        {isLoading ? (
                            <>
            ...
            <Button
                ...
                onClick={() => authClient.signIn.social({ provider: "google", callbackURL: "/api/auth/provider-google-callback" })}
            >
